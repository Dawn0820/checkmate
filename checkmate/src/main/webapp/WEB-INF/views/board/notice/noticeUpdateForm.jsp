...
<body style="padding-top: 7rem;">
	...
	<main role="main" class="container back-image">
		...
		<form name="form" method="POST" action="update.no"
			...
			<input class="form-control col-4 text-center float-left" type="text"
				...
				readonly> 
				<input class="form-control col-4 text-center float-left" type="text" value="${n.userNick}" aria-label="input example" readonly> 
				<input class="form-control col-4 text-center float-left" type="text" value="${n.date}" aria-label="input example" readonly>
				<input class="form-control col-4 text-center" type="text"
				value="${n.view}" readonly>
			<div class="pt-1"></div>
			...
			<div class="pt-1">
				<textarea class="form-control" name="noticeContent"
					...
					placeholder="내용을 입력해주세요" style="width: 100%;">${n.noticeContent}</textarea>
